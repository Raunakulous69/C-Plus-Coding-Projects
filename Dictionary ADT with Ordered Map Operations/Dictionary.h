...
private:
   ...
   // order determined by a pre-order tree walk.
...
public:
   ...
   // Consecutive (key, value) pairs are separated by a newline "\n" 
   // character, and the items key and value are separated by the sequence 
   // space-colon-space " : ". The pairs are arranged in order, as defined 
   // by the order operator <.
   ...
   // equals()
   // Returns true if and only if this Dictionary contains the same 
   // (key, value) pairs as Dictionary D.
